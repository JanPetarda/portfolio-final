...
//                 </div>
//                 <div className="menu lg:mb-4 hidden md:block md:w-auto id='navbar'">
  ...
  return (
    <nav className="fixed mx-auto border border-[#33353F] top-0 left-0 right-0 z-10 bg-[#121212] bg-opacity-70">
      <div className="flex container lg:py-4 flex-wrap items-center justify-between mx-auto px-4 py-2">
        <Link
          href={"/"}
          className="text-2xl md:text-5xl text-white font-semibold  hover:text-purple-500 transition-colors duration-700"
        >
          MS
        </Link>
        <div className="mobile-menu block md:hidden">
