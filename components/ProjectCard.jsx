...
const ProjectCard = ({ imgUrl, title, description, link, git }) => {
    return (
        <div className="transition duration-300 ease-in-out hover:scale-105"> 
            <div className="h-52 md:h-72 rounded-t-xl relative group  " style={{ background: `url(${imgUrl})`, backgroundSize: "cover" }}>
                ...
                bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500 ">
                    ...
                    className="h-14 w-14 border-2 relative rounded-full border-[#ADB7BE] hover:border-white group/link mr-7" >
